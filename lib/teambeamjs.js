...
// the logged in user
var principal = exports.principal = new User();
...
program
		.command('download', {
			...
			action: function(args, flags) {
				...
				console.log('args: %j; flags: %j', args, flags);
				...
				.then(function() {
					console.log('User %j has logged in', principal.realname);
					console.log('User is of type %j', principal.clientType);
				})
				.then(function() {
					// do the download
